...
const Track = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios
        .post(process.env.REACT_APP_BASE_URL + "/posts/deletePost", {
          post_id: item_key,
        })
  ...
  const handleSubmitPickedUp = async (
    ...
    try {
      await axios.post(process.env.REACT_APP_BASE_URL + "/posts/pickedUp", {
        post_id: item_key,
      });
      await axios
        .post(process.env.REACT_APP_BASE_URL + "/posts/send-text-message", {
  ...
  const handleSubmitDelivered = async (
    ...
    try {
      await axios.post(process.env.REACT_APP_BASE_URL + "/posts/delivered", {
        post_id: item_key,
      });
      await axios
        .post(process.env.REACT_APP_BASE_URL + "/posts/send-text-message", {
                        ...
                        <div>
                          <div class="driver-track-details">
                            ...
                            <div class="driver-details">
                              <p
                                class="card-text text-driver-details2"
                                id="description"
                                name="description"
                              >
                      ...
                      (post.driver_id === null || post.shelter_id === null) ? (
                        ...
                        <div>
                          <div class="driver-track-details">
                            ...
                            <div class="driver-details">
                              <p
                                class="card-text text-driver-details"
                                id="description"
                                name="description"
                              >
                                None
                      ...
                      post.completed === 1 ? (
                        <div>
                          <div class="already-req-banner complete-deliv">
                            <p class="card-text already-requested delivered">
                              Completed{" "}
                            </p>
                          </div>
                        </div>
